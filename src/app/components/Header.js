...
const Header = () => {
    ...
    return (
        <div className="flex items-center justify-between p-6 bg-white dark:bg-gray-900  border-b dark:hover:border-gray-700">

            <div className="flex items-center">
                <Link href="/" className="flex items-center gap-2">
                    <Video className="w-8 h-8 text-blue-500" />
                    <span className="hidden md:block text-xl font-semmibold text-gray-800 dark:text-white">
                        Google Meet
                    </span>
                </Link>
            </div>
